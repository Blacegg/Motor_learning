...
#define TIM_COM_TS_ITRx TIM_TS_ITR2 // 内部触发配置(TIM1->ITR3->TIM4)
...
#define HALL_INPUT_AF_ENABLE() __HAL_AFIO_REMAP_TIM3_ENABLE();

/* TIM4 通道 1 引脚 */
#define HALL_INPUTU_PIN GPIO_PIN_6
#define HALL_INPUTU_GPIO_PORT GPIOC
#define HALL_INPUTU_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()

/* TIM4 通道 2 引脚 */
#define HALL_INPUTV_PIN GPIO_PIN_7
#define HALL_INPUTV_GPIO_PORT GPIOC
#define HALL_INPUTV_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()

/* TIM4 通道 3 引脚 */
#define HALL_INPUTW_PIN GPIO_PIN_8
#define HALL_INPUTW_GPIO_PORT GPIOC
#define HALL_INPUTW_GPIO_CLK_ENABLE() __HAL_RCC_GPIOC_CLK_ENABLE()
