...
void KEY_GPIO_Config(void)
{
    ...
    GPIO_InitDtructure.Pin = KEY3_GPIO_Pin;
    HAL_GPIO_Init(KEY3_GPIO_PORT, &GPIO_InitDtructure);

    GPIO_InitDtructure.Pin = KEY4_GPIO_Pin;
    HAL_GPIO_Init(KEY4_GPIO_PORT, &GPIO_InitDtructure);
}
