...
#define SHUTDOWN_PIN                      GPIO_PIN_12     /* PF10 */
...
#define HALL1_U_GPIO_CLK_ENABLE()    do{  __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)    /* PH口时钟使能 */

#define HALL1_TIM_CH2_PIN           GPIO_PIN_1     /* V */
#define HALL1_TIM_CH2_GPIO          GPIOA
#define HALL1_V_GPIO_CLK_ENABLE()    do{  __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)    /* PH口时钟使能 */

#define HALL1_TIM_CH3_PIN           GPIO_PIN_2     /* W */
#define HALL1_TIM_CH3_GPIO          GPIOA
#define HALL1_W_GPIO_CLK_ENABLE()    do{  __HAL_RCC_GPIOA_CLK_ENABLE(); }while(0)    /* PH口时钟使能 */
